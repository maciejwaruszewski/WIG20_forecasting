...
plt.plot(real_stock_price, color= 'red', label= 'Real WIG20 Stock Price')
plt.plot(predicted_stock_price, color= 'blue', label= 'Predicted WIG20 Stock Price')
plt.title('WIG20 Stock Price Prediction')
plt.xlabel('Time')
plt.ylabel('WIG20 Stock Price')
plt.legend()
plt.show()